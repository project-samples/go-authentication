...
type Settings struct {
	...
	EmailWhenNewEventsAround        bool `json:"emailWhenNewEventsAround,omitempty" gorm:"column:emailWhenNewEventsAround" bson:"emailWhenNewEventsAround,omitempty" dynamodbav:"emailWhenNewEventsAround,omitempty" firestore:"emailWhenNewEventsAround,omitempty"`
	...
	NotifyFeedUpdates               bool `json:"notifyFeedUpdates,omitempty" gorm:"column:notifyFeedUpdates" bson:"notifyFeedUpdates,omitempty" dynamodbav:"notifyFeedUpdates,omitempty" firestore:"notifyFeedUpdates,omitempty"`
	NotifyPostMentions              bool `json:"notifyPostMentions,omitempty" gorm:"column:notifyPostMentions" bson:"notifyPostMentions,omitempty" dynamodbav:"notifyPostMentions,omitempty" firestore:"notifyPostMentions,omitempty"`
	NotifyCommentsOfYourPosts       bool `json:"notifyCommentsOfYourPosts,omitempty" gorm:"column:notifyCommentsOfYourPosts" bson:"notifyCommentsOfYourPosts,omitempty" dynamodbav:"notifyCommentsOfYourPosts,omitempty" firestore:"notifyCommentsOfYourPosts,omitempty"`
	NotifyEventInvitations          bool `json:"notifyEventInvitations,omitempty" gorm:"column:notifyEventInvitations" bson:"notifyEventInvitations,omitempty" dynamodbav:"notifyEventInvitations,omitempty" firestore:"notifyEventInvitations,omitempty"`
	NotifyWhenNewEventsAround       bool `json:"notifyWhenNewEventsAround,omitempty" gorm:"column:notifyWhenNewEventsAround" bson:"notifyWhenNewEventsAround,omitempty" dynamodbav:"notifyWhenNewEventsAround,omitempty" firestore:"notifyWhenNewEventsAround,omitempty"`
	ShowMyProfileInSpacesAroundMe   bool `json:"showMyProfileInSpacesAroundMe,omitempty" gorm:"column:showMyProfileInSpacesAroundMe" bson:"showMyProfileInSpacesAroundMe,omitempty" dynamodbav:"showMyProfileInSpacesAroundMe,omitempty" firestore:"showMyProfileInSpacesAroundMe,omitempty"`
	ShowAroundMeResultsInMemberFeed bool `json:"showAroundMeResultsInMemberFeed,omitempty" gorm:"column:showAroundMeResultsInMemberFeed" bson:"showAroundMeResultsInMemberFeed,omitempty" dynamodbav:"showAroundMeResultsInMemberFeed,omitempty" firestore:"showAroundMeResultsInMemberFeed,omitempty"`
}
